(declare-rel write (Bool Bool (Array Int Int) (Array Int Int) Int Int Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int))
(declare-rel rewrite (Bool Bool (Array Int Int) (Array Int Int) Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int))
(declare-rel wipe (Bool Bool (Array Int Int) (Array Int Int) Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int))
(declare-rel skip_write (Bool Bool (Array Int Int)  (Array Int Int) Int Int Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int))
(declare-rel skip_read (Bool Bool (Array Int Int) (Array Int Int) Int Int Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int))
(declare-rel read (Bool Bool (Array Int Int) (Array Int Int) Int Int Int Int (Array Int Int) (Array Int Int) Int Int Int Int Int Int))
...
(rule (=> (and
  ...
  (=> p1 (= wp0_1 (+ 1 wp1)))
  (=> p2 (= wp0_2 (+ 1 wp2))))
  (write p1 p2 a1 a2 wp1 wp2 rp1 rp2 s1 s2 a0_1 a0_2 wp0_1 wp0_2 rp1 rp2)))
...
(rule (=> (and
  ...
  (=> p1 (= a0_1 a1))
  (=> p2 (= a0_2 a2)))
  (rewrite p1 p2 a1 a2 wp1 wp2 rp1 rp2 a0_1 a0_2 rp0_1 rp0_2 wp0_1 wp0_2)))
...
(rule (=> (and
  (=> p1 (= wp0_1 (+ amt1 wp1)))
  (=> p2 (= wp0_2 (+ amt2 wp2))))
  (skip_write p1 p2 a1 a2 wp1 wp2 rp1 rp2 amt1 amt2 a1 a2 wp0_1 wp0_2 rp1 rp2)))
...
(rule (=> (and
  ...
  (skip_read p1 p2 a1 a2 wp1 wp2 rp1 rp2 amt1 amt2 a1 a2 wp1 wp2 rp0_1 rp0_2)))
...
(rule (=> (and
  ...
  (=> p1 (= rp0_1 (+ rp1 1)))
  (=> p2 (= rp0_2 (+ rp2 1))))
  (read p1 p2 a1 a2 wp1 wp2 rp1 rp2 a1 a2 wp1 wp2 rp0_1 rp0_2 out1 out2)))

(rule (=> (and
    (=> (and p1 p2) (and (= s1 s2) (= amt1 amt2)))
    (=> p1 (= wp1 0))
    (=> p2 (= wp2 0))
    (=> p1 (= rp1 0))
    (=> p2 (= rp2 0))
    (or p1 p2)
    ; write secrets
    (write p1 p2 a1 a2 wp1 wp2 rp1 rp2 s1 s2 a0_1 a0_2 wp0_1 wp0_2 rp0_1 rp0_2)
    (write p1 p2 a0_1 a0_2 wp0_1 wp0_2 rp0_1 rp0_2 s1 s2 a1_1 a1_2 wp1_1 wp1_2 rp1_1 rp1_2)
    (write p1 p2 a1_1 a1_2 wp1_1 wp1_2 rp1_1 rp1_2 s1 s2 a2_1 a2_2 wp2_1 wp2_2 rp2_1 rp2_2)
    ; call rewrite
    (rewrite p1 p2 a3_1 a3_2 wp3_1 wp3_1 rp3_1 rp3_2 a4_1 a4_2 wp4_1 wp4_2 rp4_1 rp4_2)
    (skip_write p1 p2 a4_1 a4_2 wp4_1 wp4_2 rp4_1 rp4_2 amt1 amt2 a5_1 a5_2 wp5_1 wp5_2 rp5_1 rp5_2)
    (skip_read p1 p2 a5_1 a5_2 wp5_1 wp5_2 rp5_1 rp5_2 (- amt1 1) (- amt2 1) a6_1 a6_2 wp6_1 wp6_2 rp6_1 rp6_2)
    (read p1 p2 a6_1 a6_2 wp6_1 wp6_2 rp6_1 rp6_2 a7_1 a7_2 wp7_1 wp7_2 rp7_1 rp7_2 out1 out2)
    ; "wipe"
    (wipe p1 p2 a2_1 a2_2 wp2_1 wp2_2 rp2_1 rp2_2 a3_1 a3_2 wp3_1 wp3_2 rp3_1 rp3_2)
