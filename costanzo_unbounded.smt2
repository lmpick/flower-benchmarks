...
(declare-rel loop (Bool Bool Int Int (Array Int Int) (Array Int Int) Int Int Bool))
(declare-rel main (Bool Bool (Array Int Int) (Array Int Int) Int Int Bool))
...
(rule (=> (and
  ...
  (requirement l1 l2 (+ i1 1) (+ i2 1) a1 a2 len1 len2))
  (requirement p1 p2 i1 i2 a1 a2 len1 len2)))
...
(rule (=> (and
  ...
  (=> l1 (= i1_i (+ i1 1)))
  (=> l2 (= i2_i (+ i2 1)))
  (loop p1 p2 i1_i i2_i a1 a2 len1 len2 ok_i))
  (loop p1 p2 i1 i2 a1 a2 len1 len2 (and ok ok_i))))

(rule (=>
  (not (or (and p1 (< i1 len1)) (and p2 (< i2 len2))))
  (loop p1 p2 i1 i2 a1 a2 len1 len2 true)))

(rule (=> (and
  (requirement p1 p2 0 0 a1 a2 len1 len2)
  (=> p1 (= i1 0))
  (=> p2 (= i2 0))
  (loop p1 p2 i1 i2 a1 a2 len1 len2 ok))
  (main p1 p2 a1 a2 len1 len2 ok)))
